...
{           
   ...
   vec3 pointToCameraDirWS =normalize(viewPos - fs_in.FragPos);

   texCoords=updateUV(depthMap,pointToCameraDirWS,fs_in.N,fs_in.T,fs_in.B,5.0,fs_in.TexCoords,vec2(1.0,1.0),1.0);
